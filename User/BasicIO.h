...
//XDATA地址分配
#define XBASE_KEY_BUF		(XBASE_RGB_BUF - KP_NUM*6)
#define XBASE_RGB_BUF		(XBASE_EP0_BUF - 16*6)
#define XBASE_EP0_BUF		(XBASE_FLASH_BUF - 64*5)
#define XBASE_EP2_BUF		(XBASE_EP0_BUF + 64*1)
#define XBASE_EP1_BUF		(XBASE_EP0_BUF + 64*3)
#define XBASE_SERIAL_NUM	(XBASE_FLASH_BUF - 26 - 2*4)
#define XBASE_ADC_BUF		(XBASE_FLASH_BUF - 2*4)
